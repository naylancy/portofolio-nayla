...
// JavaScript for the Achievement Section
const filterButtons = document.querySelectorAll('.filter-buttons .btn');
const portfolioItems = document.querySelectorAll('.portfolio-gallery');
...
filterButtons.forEach(button => {
  button.addEventListener('click', () => {
    ...
    portfolioItems.forEach(item => {
      const categories = item.querySelector('.port-content h3').textContent.toLowerCase();
...
document.querySelector('.formBtn').addEventListener('click', function(event) {
  ...
  // Here you can implement the logic to send the form data to the server
